    ...
    <section id="process" className="py-16 bg-white">
      <div className="container mx-auto px-6 max-w-7xl">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex items-center gap-8">
                  <div className={`hidden md:flex w-20 h-20 rounded-full bg-gradient-to-br ${step.color} items-center justify-center flex-shrink-0 shadow-lg z-10 ring-4 ring-white`}>
                    <span className="text-white font-bold text-3xl">{index + 1}</span>
                  </div>

                  <div className="flex md:hidden w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 items-center justify-center flex-shrink-0 shadow-lg">
                    <span className="text-white font-bold text-2xl">{index + 1}</span>
                  </div>

                  <div className="flex-1">
                    <div className="bg-slate-50 rounded-2xl p-8 md:p-10 hover:shadow-xl transition-all hover:-translate-y-1 duration-300">
                      <div className="flex items-center gap-5 mb-4">
                        <div className={`w-16 h-16 md:w-18 md:h-18 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center flex-shrink-0 shadow-md`}>
                      ...
                      <p className="text-lg text-slate-600 leading-relaxed ml-0 md:ml-20">
                        {step.description}
                      </p>
                    </div>
                  </div>
        ...
        <div className="mt-14 text-center">
          <div className="inline-block bg-blue-50 border-2 border-blue-200 rounded-xl px-10 py-8">
