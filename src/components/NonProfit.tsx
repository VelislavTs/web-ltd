  ...
  return (
    <section className="py-16 bg-gradient-to-br from-emerald-50 to-teal-50">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="bg-white rounded-2xl p-10 md:p-14 shadow-xl">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-8 rounded-r-lg mb-10">
          ...
          <button
            ...
            className="w-full md:w-auto bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-5 rounded-lg text-lg font-semibold transition-colors shadow-lg hover:shadow-emerald-500/50"
          >
            {t.nonprofit.cta}
          </button>
        </div>

        <div className="mt-8 text-center text-slate-600 text-base">
